...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        for convnext, convnext2, attn, downsample in self.downs: # convnext, convnext2, attn, downsample
            x = convnext(x, t)
            x = convnext2(x, t)
            x = attn(x)
            h.append(x)
        ...
        for convnext, convnext2, attn, upsample in self.ups: # convnext, convnext2, attn, upsample
